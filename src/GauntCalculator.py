...
def freeFreeEmissionSpectrum(Z, en, Ev):
    ...
    @param e : Energy in the spectrum for which to calculate the emission.
    @unit    : Ha
    @param v : Velocity of the impingig electron
    @unit    : velocity of light c
    """
...
def gauntFactorFF(Z, electron_velocity, photon_energy):
